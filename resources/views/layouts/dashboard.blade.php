	...
	<section class="body">
		...
		<header class="header">
			<div class="logo-container">
				<a href="../" class="logo">
					<img src="{{ asset('img/logo.png') }}" height="40" alt="Porto Admin') }}">
				</a>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="/uploads/avatars/{{ Auth::user()->avatar }}" alt="{{ Auth::user()->name.' '.Auth::user()->surname }} " class="img-circle" data-lock-picture="/uploads/avatars/{{ Auth::user()->avatar }}">
						</figure>
						...
						<ul class="nav nav-main">
							...
							<li class="nav-parent">
								...
								<ul class="nav nav-children">
									<li>
										<a href="{{ url('admin/users') }}">Lista</a>
